...
#		Done: Find hjørnet (eller cut direkte til hjørnet)
#		minLineSize bør være dynamisk somehow - evt bare ift. opløsning på kamera
#       Overvej om der skal bruges blur før findContours (kan altid gøres senere)
#       Done: Bør tage vinkel i betragtning
        ...
        try:
            if linelength > minLineSize:
                ...
                if 80 < deg < 100:
                    ...
                    botCut = np.float32([[0, 0], [0, 240], [120, 240], [120, 0]]) #120 x 240
                    ...
                    blurDenoised = cv2.GaussianBlur(denoised, (5, 5), 0)
